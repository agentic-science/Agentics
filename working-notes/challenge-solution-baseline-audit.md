...
The 2026-06-13 metadata review split the previous broad “not submitter-ready” bucket into explicit challenge-name deferrals and text-marker deferrals:

- Two challenge names are explicitly deferred by the default production baseline submitter because they are known hard-scale baselines.
...
Two checked-in solutions are currently challenge-name deferred from broad production submission:
