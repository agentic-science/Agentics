...
| `disk-probing-frontier-cs-algorithmic-60` | piped protocol stalls on official data | solution handles protocol closure and sentinel framing poorly | solution | fixed locally with bounded fallback and EOF/sentinel handling |
...
| `hidden-circuit-gates-frontier-cs-algorithmic-101` | quick protocol/correctness failure | final gate reconstruction and `-1`/EOF handling are fragile | solution | fixed locally with `-1`, `NEXT`, malformed, and EOF guards |
...
| `induced-triple-graph-frontier-cs-algorithmic-120` | interactive evaluator timeout around 120s | many queries per official case | evaluator wrapper | structured failure supported; current solver kept as meaningful but hard-scale best effort |
...
| `mineral-pairing-frontier-cs-algorithmic-125` | interactive evaluator timeout around 120s | query-heavy baseline exceeds official budget | solution + evaluator wrapper | fixed locally with capped signature guesser and complete pair output |
...
| `substring-ab-program-frontier-cs-algorithmic-23` | separated evaluator timeout or resource failure around 135s | fixed rewrite-program baseline is not guaranteed useful on official scale | structured evaluator path | current solver kept; runner now preserves structured nonzero/timeout metadata for evaluator classification |
...
| Outcome | Challenges |
| --- | --- |
| Completed after repair | `cycle-chord-identification-frontier-cs-algorithmic-16`, `demagnetized-magnets-frontier-cs-algorithmic-255`, `disk-probing-frontier-cs-algorithmic-60`, `dna-matching-probability-frontier-cs-algorithmic-121`, `graph-isomorphism-edge-match-frontier-cs-algorithmic-180`, `greedy-tree-blackbox-frontier-cs-algorithmic-93`, `hamiltonian-path-frontier-cs-algorithmic-5`, `hidden-circuit-gates-frontier-cs-algorithmic-101`, `hidden-cycle-length-frontier-cs-algorithmic-14`, `ink-pen-selection-frontier-cs-algorithmic-68`, `maximum-position-permutation-frontier-cs-algorithmic-17`, `mineral-pairing-frontier-cs-algorithmic-125`, `modulo-collision-size-frontier-cs-algorithmic-36`, `online-mst-decisions-frontier-cs-algorithmic-153`, `poker-action-seeds-frontier-cs-algorithmic-143`, `scp-maze-exit-frontier-cs-algorithmic-85`, `sorted-mode-array-frontier-cs-algorithmic-257`, `steiner-tree-reconstruction-frontier-cs-algorithmic-89`, `tree-centroid-guess-frontier-cs-algorithmic-54`, `weighted-tree-distances-frontier-cs-algorithmic-10`, `world-map-frontier-cs-algorithmic-6` |
| Structured failed with diagnostics | `dango-stick-grouping-frontier-cs-algorithmic-217`, `impartial-game-graph-frontier-cs-algorithmic-231`, `induced-triple-graph-frontier-cs-algorithmic-120`, `substring-ab-program-frontier-cs-algorithmic-23` |
| Intentionally deferred | No challenge is fully deferred from runner/evaluator diagnostics. The four structured-failure entries still need stronger official-scale baselines if we want positive production scores rather than diagnostic failures. |
