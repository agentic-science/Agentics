...
| `substring-ab-program-frontier-cs-algorithmic-23` | separated evaluator timeout or resource failure around 135s | official-shaped cases `13..22` exceeded the old evaluator budget | baseline/checker | cleared on 2026-06-24 after increasing trusted checker/evaluator budget; production submission `c1385f37-fc62-49e4-b910-14b0f04774e3` completed with score 100.0 |
...
The two later hard-case deferrals were cleared on 2026-06-24. `substring-ab-program-frontier-cs-algorithmic-23` now has enough trusted checker/evaluator budget for official-shaped cases `13..22`, and `colored-ball-pole-sorting-frontier-cs-algorithmic-142` now uses a divide-and-conquer construction that stays under the operation cap on upstream-shaped `50 x 400` cases.
...
| Cleared hard algorithmic deferrals | `colored-ball-pole-sorting-frontier-cs-algorithmic-142` production submission `112bfd88-b7e6-4be9-92db-cdce9fce2518` completed with score 46.815; `substring-ab-program-frontier-cs-algorithmic-23` production submission `c1385f37-fc62-49e4-b910-14b0f04774e3` completed with score 100.0 |
