...
pub(crate) async fn reject_failed_pioneer_code() -> ServiceError {
...
pub(crate) fn invalid_pioneer_code() -> ServiceError {
...
pub(crate) fn is_invalid_pioneer_code(error: &ServiceError) -> bool {
