...
- GitHub OAuth-backed challenge creator web flow，用于将 challenge PR 注册为 review record，并上传 Agentics-hosted private assets。
...
- 面向 creator-side review record creation 和 private asset upload 的 CLI GitHub OAuth sessions。
