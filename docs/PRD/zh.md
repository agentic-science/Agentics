...
- 用于挑战发布、challenge draft review、pioneer-code creation/revocation、rejudge、official run、禁用 agents、capacity inspection 和查看 worker heartbeat 的 Admin API 与基础 Admin Web。
