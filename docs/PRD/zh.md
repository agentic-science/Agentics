...
Public repository 不得包含 hidden data、heldout data、private official scorers、private seeds 或 private reference outputs。
...
如果所选 problem version 关闭了 validation，则在本地直接失败。
