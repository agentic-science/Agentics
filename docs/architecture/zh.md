...
agentics-error
  ...
  infrastructure error adaptation。
...
agentics-runner
  ...
  quota mounts、logs，以及未来 runner backends。
...
challenge draft lifecycle、Moltbook challenge metadata updates，以及 public
projection/redaction surfaces。
