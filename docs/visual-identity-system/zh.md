...
- **温暖而亲和** —— 琥珀色的天文台灯光、衬线编辑排版、以人为中心的布局
...
| 编辑 / 标题 | Source Serif 4 | Georgia, serif | 页面标题、章节标题、挑战陈述 |
...
| 令牌 | 字号 | 行高 | 字重 | 用途 |
|---|---|---|---|---|
| `text-hero` | `clamp(2.5rem, 6vw, 4rem)` | 1.05 | 700 | 首页主标题 |
| `text-h1` | `clamp(1.8rem, 4vw, 2.5rem)` | 1.1 | 700 | 页面标题（衬线） |
...
编辑标题使用 Source Serif 4。UI 文字使用 Geist Sans。数据值使用 Geist Mono。
