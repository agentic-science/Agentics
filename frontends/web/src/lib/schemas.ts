...
export const publicSolutionSubmissionListItemDtoSchema = z
  .object({
    ...
    parent_solution_submission_id: z.string().min(1).optional(),
    credit_text: z.string(),
    validation_score: scoreSchema.optional(),
    official_score: z.number().finite().optional(),
    rank_score: z.number().finite().optional(),
    aggregate_metrics: z.array(metricValueSchema),
...
export const solutionSubmissionResponseSchema = z
  .object({
    ...
    evaluation_job: evaluationJobDtoSchema.optional(),
    evaluation: evaluationDtoSchema.optional(),
    validation_evaluation: evaluationDtoSchema.optional(),
    official_evaluation: evaluationDtoSchema.optional(),
    created_at: isoTimestampSchema,
    updated_at: isoTimestampSchema,
  })
  .strict();
